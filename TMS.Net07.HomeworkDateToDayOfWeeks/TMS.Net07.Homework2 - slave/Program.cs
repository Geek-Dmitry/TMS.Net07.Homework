    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("This program translate the days of the week." +
                "\n Just enter name of the day on english." +
                "\n Еnter exit for closing program.");

            for (input = Console.ReadLine().ToLower(); Equals(input, "exit") == false; Console.WriteLine("\nPlease, enter another day of week.\n Enter exit for closing program\n"), input = Console.ReadLine().ToLower())
            {
                switch (input)
                {
                    case "monday":
